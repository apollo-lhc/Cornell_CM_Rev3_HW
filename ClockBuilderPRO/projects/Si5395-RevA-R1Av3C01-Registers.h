 ...
 * Timestamp:                                          2025-01-22 11:55:48 GMT-05:00
 *
 ...
 * Project File:       D:\6089-127_CM_V3\GitHub\Cornell_CM_Rev3_HW\ClockBuilderPRO\projects\Si5395-RevA-R1Av3C01-Project.slabtimeproj
 * Design ID:          R1Av3C01
 * Created By:         ClockBuilder Pro v4.13.0.2 [2024-06-10]
 * Timestamp:          2025-01-22 11:55:47 GMT-05:00
 * 
 * Design Notes
 * ============
 * 
 * Synthesizer R1A for Apollo CMv3, 6089-127-RevA, schematic sheet 2.09
 * v3C01: Use ATCA clock at input IN_0 for 320.63 MHz on all outputs, also zero delay mode
 * 
 * Design Rule Check
 * =================
 * 
 ...
 * 
 * Fvco = 13.46688 GHz
 * Fpfd = 1.9432727272727272... MHz [ 1 + 1297/1375 MHz ]
 * Fms0 = 641.28 MHz
 * Fms1 = 641.28 MHz
 * 
 * P dividers:
 ...
 * ----------------------------  -------  -------  ----  ----
 * Typical Ta, Voltage, Current  1.017 W  945 mW   25 C  42 C
 * 
 *                                    -----------------------
 *                                            Typical        
 *                                    -----------------------
 ...
 * VDD                                   1.80      156    280
 * VDDA                                  3.30      116    381
 * VDDO0  OUT0A   320.64 MHz    LVDS     1.80       33     59
 *        OUT0    320.64 MHz    LVDS
 * VDDO1  OUT1    320.64 MHz    LVDS     1.80       16     30
 * VDDO2  OUT2    320.64 MHz    LVDS     1.80       16     30
 * VDDO3  OUT3    320.64 MHz    LVDS     1.80       16     30
 * VDDO4  OUT4    320.64 MHz    LVDS     1.80       16     30
 * VDDO5  OUT5    320.64 MHz    LVDS     1.80       16     30
 * VDDO6  OUT6    320.64 MHz    LVDS     1.80       16     30
 * VDDO7  OUT7    320.64 MHz    LVDS     1.80       16     30
 * VDDO8  OUT8    320.64 MHz    LVDS     1.80       16     30
 * VDDO9  OUT9    320.64 MHz    LVDS     1.80       33     59
 ...
 * 0x0036[15:0]  LOS0_CLR_THR                1                  0x0001           
 ...
 * 0x00A9[28:0]  LOL_CLR_DELAY_DIV256        24975              0x0000618F       
 ...
 * 0x0208[47:0]  P0_NUM                      165                0x0000000000A5   
 ...
 * 0x0226[47:0]  P3_NUM                      165                0x0000000000A5   
 ...
 * 0x030D[43:0]  N1_NUM                      45097156608        0x00A80000000    
 ...
 * 0x058B[19:0]  HSW_MEAS_SETTLE             22540              0x0580C          
 ...
 * 0x05AD[15:0]  OUT_MAX_LIMIT_LMT           18386              0x47D2           
 * 0x05B1[15:0]  HOLD_SETTLE_TARGET          753                0x02F1           
