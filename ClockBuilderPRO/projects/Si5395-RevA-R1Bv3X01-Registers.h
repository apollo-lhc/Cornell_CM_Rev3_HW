 ...
 * Timestamp:                                          2025-01-29 14:52:10 GMT-05:00
 *
 ...
 * 
 * Part:               Si5395AB Rev A
 * Project File:       D:\6089-127_CM_V3\GitHub\Cornell_CM_Rev3_HW\ClockBuilderPRO\projects\Si5395-RevA-R1Bv3X01-Project.slabtimeproj
 * Design ID:          R1Bv3X01
 * Created By:         ClockBuilder Pro v4.13.0.2 [2024-06-10]
 * Timestamp:          2025-01-29 14:52:09 GMT-05:00
 * 
 * Design Notes
 * ============
 * 
 * Synthesizer R1B for Apollo CMv3, 6089-127-RevA, schematic sheet 2.10
 ...
 * Device Grade
 * ============
 * Maximum Output Frequency: 326 MHz
 ...
 * 
 * Outputs:
 *   OUT0A: 176 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT0: 220 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT1: 110 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT2: 132 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT3: 296 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT4: 163 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT5: 326 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT6: 148 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT7: 268 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT8: 134 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT9: 55 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *   OUT9A: Unused
 * 
 * Output Enable:
 ...
 *       OUT9: 55 MHz
 *    N1:
 *       Value: 26.2686567164179104... [ 26 + 18/67 ]
 *       OUT7: 268 MHz
 *       OUT8: 134 MHz
 *    N2:
 *       Value: 23.7837837837837837... [ 23 + 29/37 ]
 *       OUT3: 296 MHz
 *       OUT6: 148 MHz
 *    N3:
 *       Value: 21.5950920245398773... [ 21 + 97/163 ]
 *       OUT4: 163 MHz
 *       OUT5: 326 MHz
 *    N4:
 *       Value: 53.3333333333333333... [ 53 + 1/3 ]
 *       OUT2: 132 MHz
 * 
 * R dividers:
 *    R0A = 10
 ...
 * 
 * N1: 26.2686567164179104... [ 26 + 18/67 ]
 * 
 *    OUT7  268 MHz
 *    OUT8  134 MHz
 * 
 ...
 * 
 * N2: 23.7837837837837837... [ 23 + 29/37 ]
 * 
 *    OUT3  296 MHz
 *    OUT6  148 MHz
 * 
 ...
 * 
 * N3: 21.5950920245398773... [ 21 + 97/163 ]
 * 
 *    OUT4  163 MHz
 *    OUT5  326 MHz
 * 
 ...
 * ----------------------------  -------  -------  ----  ----
 * Typical Ta, Voltage, Current  1.141 W  1.075 W  25 C  44 C
 * 
 *                                   -----------------------
 *                                           Typical        
 *                                   -----------------------
 ...
 * VDD                                  1.80      238    429
 * VDDA                                 3.30      121    398
 * VDDO0  OUT0A     176 MHz    LVDS     1.80       32     57
 *        OUT0      220 MHz    LVDS
 * VDDO1  OUT1      110 MHz    LVDS     1.80       16     28
 * VDDO2  OUT2      132 MHz    LVDS     1.80       16     28
 * VDDO3  OUT3      296 MHz    LVDS     1.80       16     29
 * VDDO4  OUT4      163 MHz    LVDS     1.80       16     28
 * VDDO5  OUT5      326 MHz    LVDS     1.80       16     30
 * VDDO6  OUT6      148 MHz    LVDS     1.80       16     28
 * VDDO7  OUT7      268 MHz    LVDS     1.80       16     29
 * VDDO8  OUT8      134 MHz    LVDS     1.80       16     28
 * VDDO9  OUT9       55 MHz    LVDS     1.80       15     27
 *        OUT9A      Unused        
 *                                   -------  -------  -----
 *                                      1.80      412    742
 *                                      3.30      121    398
 ...
 * 0x0302[43:0]  N0_NUM                      17179869184        0x00400000000    
 * 0x0308[31:0]  N0_DEN                      2147483648         0x80000000       
 * 0x030C[0]     N0_UPDATE                   0                  0x0              
 * 0x030D[43:0]  N1_NUM                      59055800320        0x00DC0000000    
 * 0x0313[31:0]  N1_DEN                      2248146944         0x86000000       
 * 0x0317[0]     N1_UPDATE                   0                  0x0              
 * 0x0318[43:0]  N2_NUM                      59055800320        0x00DC0000000    
 * 0x031E[31:0]  N2_DEN                      2483027968         0x94000000       
 * 0x0322[0]     N2_UPDATE                   0                  0x0              
 * 0x0323[43:0]  N3_NUM                      59055800320        0x00DC0000000    
 * 0x0329[31:0]  N3_DEN                      2734686208         0xA3000000       
 * 0x032D[0]     N3_UPDATE                   0                  0x0              
 * 0x032E[43:0]  N4_NUM                      171798691840       0x02800000000    
 * 0x0334[31:0]  N4_DEN                      3221225472         0xC0000000       
