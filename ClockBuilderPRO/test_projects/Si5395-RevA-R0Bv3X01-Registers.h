 ...
 * Timestamp:                                          2025-01-29 14:46:58 GMT-05:00
 *
 ...
 * 
 * Part:               Si5395AB Rev A
 * Project File:       D:\6089-127_CM_V3\GitHub\Cornell_CM_Rev3_HW\ClockBuilderPRO\projects\Si5395-RevA-R0Bv3X01-Project.slabtimeproj
 * Design ID:          R0Bv3X01
 * Created By:         ClockBuilder Pro v4.13.0.2 [2024-06-10]
 * Timestamp:          2025-01-29 14:46:58 GMT-05:00
 * 
 ...
 * Device Grade
 * ============
 * Maximum Output Frequency: 310 MHz
 ...
 * Outputs:
 *   OUT0A: Unused
 *    OUT0: 310 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT1: 155 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT2: 290 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT3: 145 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT4: 270 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT5: 135 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT6: 250 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT7: 125 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT8: 230 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT9: Unused
 *   OUT9A: Unused
 * 
 ...
 *       OUT5: 135 MHz
 *    N2:
 *       Value: 23.2758620689655172... [ 23 + 8/29 ]
 *       OUT2: 290 MHz
 *       OUT3: 145 MHz
 *    N3:
 *       Value: 21.7741935483870967... [ 21 + 24/31 ]
 *       OUT0: 310 MHz
 *       OUT1: 155 MHz
 *    N4:
 *       Value: 29.3478260869565217... [ 29 + 8/23 ]
 *       OUT8: 230 MHz
 * 
 * R dividers:
 *    R0A = Unused
 ...
 * 
 * N2: 23.2758620689655172... [ 23 + 8/29 ]
 * 
 *    OUT2  290 MHz
 *    OUT3  145 MHz
 * 
 ...
 * 
 * N3: 21.7741935483870967... [ 21 + 24/31 ]
 * 
 *    OUT0  310 MHz
 *    OUT1  155 MHz
 * 
 ...
 * 
 * N4: 29.3478260869565217... [ 29 + 8/23 ]
 * 
 *    OUT8  230 MHz
 * 
 *    Desired Dynamic Skew Step:  ±0.000 ps
 ...
 * ----------------------------  -------  -------  ----  ----
 * Typical Ta, Voltage, Current  1.039 W  985 mW   25 C  43 C
 * 
 *                                   -----------------------
 *                                           Typical        
 *                                   -----------------------
 ...
 * VDD                                  1.80      215    386
 * VDDA                                 3.30      119    394
 * VDDO0  OUT0A      Unused             1.80       16     30
 *        OUT0      310 MHz    LVDS
 * VDDO1  OUT1      155 MHz    LVDS     1.80       16     28
 * VDDO2  OUT2      290 MHz    LVDS     1.80       16     29
 * VDDO3  OUT3      145 MHz    LVDS     1.80       16     28
 * VDDO4  OUT4      270 MHz    LVDS     1.80       16     29
 * VDDO5  OUT5      135 MHz    LVDS     1.80       16     28
 * VDDO6  OUT6      250 MHz    LVDS     1.80       16     29
 * VDDO7  OUT7      125 MHz    LVDS     1.80       16     28
 * VDDO8  OUT8      230 MHz    LVDS     1.80       16     29
 * VDDO9  OUT9       Unused        
 *        OUT9A      Unused        
 *                                   -------  -------  -----
 *                                      1.80      358    645
 ...
 * 0x030D[43:0]  N1_NUM                      53687091200        0x00C80000000    
 * 0x0313[31:0]  N1_DEN                      2147483648         0x80000000       
 * 0x0317[0]     N1_UPDATE                   0                  0x0              
 * 0x0318[43:0]  N2_NUM                      90596966400        0x01518000000    
 * 0x031E[31:0]  N2_DEN                      3892314112         0xE8000000       
 * 0x0322[0]     N2_UPDATE                   0                  0x0              
 * 0x0323[43:0]  N3_NUM                      90596966400        0x01518000000    
 * 0x0329[31:0]  N3_DEN                      4160749568         0xF8000000       
 * 0x032D[0]     N3_UPDATE                   0                  0x0              
 * 0x032E[43:0]  N4_NUM                      90596966400        0x01518000000    
 * 0x0334[31:0]  N4_DEN                      3087007744         0xB8000000       
