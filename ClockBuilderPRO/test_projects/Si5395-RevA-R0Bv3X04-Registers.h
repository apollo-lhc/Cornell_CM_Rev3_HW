 ...
 * Timestamp:                                          2025-02-17 13:56:16 GMT-05:00
 *
 ...
 * Project File:       D:\6089-127_CM_V3\GitHub\Cornell_CM_Rev3_HW\ClockBuilderPRO\projects\Si5395-RevA-R0Bv3X04-Project.slabtimeproj
 * Design ID:          R0Bv3X04
 * Created By:         ClockBuilder Pro v4.14 [2024-12-02]
 * Timestamp:          2025-02-17 13:56:16 GMT-05:00
 * 
 ...
 * R0Bv3X04: Use clock input "IN_2" and feedback. Depends on 40 MHz coming from the test board on the "LHC CLK" signal (probably from 6089-127 TEST BOARD). All FPGA clocks at 200 MHz.
 * 
 * Design Rule Check
 * =================
 * 
 ...
 * ----------------------------  -------  -------  ----  ----
 * Typical Ta, Voltage, Current  921 mW   861 mW   25 C  40 C
 * 
 *                                   -----------------------
 *                                           Typical        
 *                                   -----------------------
 ...
 *        OUT0      200 MHz    LVDS
 * VDDO1  OUT1      200 MHz    LVDS     1.80       16     29
 * VDDO2  OUT2      200 MHz    LVDS     1.80       16     29
 * VDDO3  OUT3      200 MHz    LVDS     1.80       16     29
 * VDDO4  OUT4      200 MHz    LVDS     1.80       16     29
 * VDDO5  OUT5      200 MHz    LVDS     1.80       16     29
 * VDDO6  OUT6      200 MHz    LVDS     1.80       16     29
 * VDDO7  OUT7      200 MHz    LVDS     1.80       16     29
 * VDDO8  OUT8      200 MHz    LVDS     1.80       16     29
 * VDDO9  OUT9       Unused             1.80       15     27
 *        OUT9A      40 MHz    LVDS
 *                                   -------  -------  -----
 *                                      1.80      300    540
 *                                      3.30      116    381
 ...
 * 0x00A9[28:0]  LOL_CLR_DELAY_DIV256        24970              0x0000618A       
 ...
 * 0x0268[23:0]  R9A_REG                     4                  0x000004         
 ...
 * 0x030D[43:0]  N1_NUM                      73014444032        0x01100000000    
 ...
 * 0x058B[19:0]  HSW_MEAS_SETTLE             22710              0x058B6          
 ...
 * 0x05AD[15:0]  OUT_MAX_LIMIT_LMT           18568              0x4888           
 * 0x05B1[15:0]  HOLD_SETTLE_TARGET          760                0x02F8           
