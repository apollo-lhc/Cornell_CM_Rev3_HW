 ...
 * Timestamp:                                          2025-02-19 16:25:55 GMT-05:00
 *
 ...
 * Project File:       D:\6089-127_CM_V3\GitHub\Cornell_CM_Rev3_HW\ClockBuilderPRO\projects\Si5395-RevA-R1Bv3X04-Project.slabtimeproj
 * Design ID:          R1Bv3X04
 * Created By:         ClockBuilder Pro v4.14 [2024-12-02]
 * Timestamp:          2025-02-19 16:25:55 GMT-05:00
 * 
 ...
 * R1Bv3X04: Use clock input "IN_2" and feedback. Depends on 40 MHz on the LHC_CLK signal coming from the test board. All FPGA clocks at 140 MHz.
 * 
 * Design Rule Check
 * =================
 * 
 ...
 *    Pxaxb = 1
 * 
 * MXAXB = 291.6666666666666666... [ 291 + 2/3 ]
 * M = 1400
 * N dividers:
 *    N0 (Zero Delay):
 *       Value: 25
 ...
 * ----------------------------  -------  -------  ----  ----
 * Typical Ta, Voltage, Current  979 mW   907 mW   25 C  41 C
 * 
 *                                   -----------------------
 *                                           Typical        
 *                                   -----------------------
 ...
 * VDD                                  1.80      145    261
 * VDDA                                 3.30      116    381
 * VDDO0  OUT0A     140 MHz    LVDS     1.80       31     56
 *        OUT0      140 MHz    LVDS
 * VDDO1  OUT1      140 MHz    LVDS     1.80       16     28
 * VDDO2  OUT2      140 MHz    LVDS     1.80       16     28
 * VDDO3  OUT3      140 MHz    LVDS     1.80       16     28
 * VDDO4  OUT4      140 MHz    LVDS     1.80       16     28
 * VDDO5  OUT5      140 MHz    LVDS     1.80       16     28
 * VDDO6  OUT6      140 MHz    LVDS     1.80       16     28
 * VDDO7  OUT7      140 MHz    LVDS     1.80       16     28
 * VDDO8  OUT8      140 MHz    LVDS     1.80       16     28
 * VDDO9  OUT9      140 MHz    LVDS     1.80       31     56
 *        OUT9A      40 MHz    LVDS
 *                                   -------  -------  -----
 *                                      1.80      332    598
 *                                      3.30      116    381
 ...
 * 0x00A9[28:0]  LOL_CLR_DELAY_DIV256        24999              0x000061A7       
 ...
 * 0x0302[43:0]  N0_NUM                      53687091200        0x00C80000000    
 * 0x0308[31:0]  N0_DEN                      2147483648         0x80000000       
 * 0x030C[0]     N0_UPDATE                   0                  0x0              
 * 0x030D[43:0]  N1_NUM                      107374182400       0x01900000000    
 ...
 * 0x0515[55:0]  M_NUM                       3006477107200      0x0002BC00000000 
 ...
 * 0x058B[19:0]  HSW_MEAS_SETTLE             23717              0x05CA5          
 ...
 * 0x05AD[15:0]  OUT_MAX_LIMIT_LMT           19114              0x4AAA           
 * 0x05B1[15:0]  HOLD_SETTLE_TARGET          782                0x030E           
