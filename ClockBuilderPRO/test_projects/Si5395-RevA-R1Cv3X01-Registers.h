 ...
 * Timestamp:                                          2025-01-29 14:54:15 GMT-05:00
 *
 ...
 * 
 * Part:               Si5395AB Rev A
 * Project File:       D:\6089-127_CM_V3\GitHub\Cornell_CM_Rev3_HW\ClockBuilderPRO\projects\Si5395-RevA-R1Cv3X01-Project.slabtimeproj
 * Design ID:          R1Cv3X01
 * Created By:         ClockBuilder Pro v4.13.0.2 [2024-06-10]
 * Timestamp:          2025-01-29 14:54:14 GMT-05:00
 * 
 * Design Notes
 * ============
 * 
 * Synthesizer R1C for Apollo CMv3, 6089-127-RevA, schematic sheet 2.11
 * v3X01: Differing output frequencies for clock distribution testing.
 * 
 * Design Rule Check
 * =================
 * 
 ...
 * Device Grade
 * ============
 * Maximum Output Frequency: 348 MHz
 ...
 * 
 * Outputs:
 *   OUT0A: 116 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT0: 232 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT1: 174 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT2: 348 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT3: 310 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT4: 170 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT5: 340 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT6: 155 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT7: 286 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT8: 143 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *    OUT9: 226 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 *   OUT9A: 113 MHz (Free Run)
 *          Enabled, LVDS 1.8 V
 * 
 * Output Enable:
 *   OUT0A: OE0
 ...
 *       OUT2: 348 MHz
 *    N1:
 *       Value: 30.7964601769911504... [ 30 + 90/113 ]
 *       OUT9: 226 MHz
 *       OUT9A: 113 MHz
 *    N2:
 *       Value: 24.3356643356643356... [ 24 + 48/143 ]
 *       OUT7: 286 MHz
 *       OUT8: 143 MHz
 *    N3:
 *       Value: 22.4516129032258064... [ 22 + 14/31 ]
 *       OUT3: 310 MHz
 *       OUT6: 155 MHz
 *    N4:
 *       Value: 20.4705882352941176... [ 20 + 8/17 ]
 *       OUT4: 170 MHz
 *       OUT5: 340 MHz
 * 
 * R dividers:
 ...
 * 
 * N1: 30.7964601769911504... [ 30 + 90/113 ]
 * 
 *    OUT9  226 MHz
 *    OUT9A 113 MHz
 * 
 ...
 * 
 * N2: 24.3356643356643356... [ 24 + 48/143 ]
 * 
 *    OUT7  286 MHz
 *    OUT8  143 MHz
 * 
 *    Desired Dynamic Skew Step:  ±0.000 ps
 *    Actual Dynamic Skew Step:   ±0 ps
 *    N2_PHASE_STEP:                 0x0 0d
 *    N2_PHASE_COUNT:                0x0 0d
 * 
 *    Use N2_PHASE_INC and N2_PHASE_DEC to perform phase step.
 * 
 * N3: 22.4516129032258064... [ 22 + 14/31 ]
 * 
 *    OUT3  310 MHz
 *    OUT6  155 MHz
 * 
 *    Desired Dynamic Skew Step:  ±0.000 ps
 *    Actual Dynamic Skew Step:   ±0 ps
 *    N3_PHASE_STEP:                 0x0 0d
 *    N3_PHASE_COUNT:                0x0 0d
 * 
 *    Use N3_PHASE_INC and N3_PHASE_DEC to perform phase step.
 * 
 * N4: 20.4705882352941176... [ 20 + 8/17 ]
 * 
 *    OUT4  170 MHz
 *    OUT5  340 MHz
 * 
 *    Desired Dynamic Skew Step:  ±0.000 ps
 *    Actual Dynamic Skew Step:   ±0 ps
 *    N4_PHASE_STEP:                 0x0 0d
 *    N4_PHASE_COUNT:                0x0 0d
 * 
 *    Use N4_PHASE_INC and N4_PHASE_DEC to perform phase step.
 * 
 ...
 * ----------------------------  -------  -------  ----  ----
 * Typical Ta, Voltage, Current  1.182 W  1.110 W  25 C  45 C
 * 
 *                                   -----------------------
 *                                           Typical        
 *                                   -----------------------
 ...
 * VDD                                  1.80      244    439
 * VDDA                                 3.30      121    398
 * VDDO0  OUT0A     116 MHz    LVDS     1.80       32     57
 *        OUT0      232 MHz    LVDS
 * VDDO1  OUT1      174 MHz    LVDS     1.80       16     28
 * VDDO2  OUT2      348 MHz    LVDS     1.80       17     30
 * VDDO3  OUT3      310 MHz    LVDS     1.80       16     30
 * VDDO4  OUT4      170 MHz    LVDS     1.80       16     28
 * VDDO5  OUT5      340 MHz    LVDS     1.80       17     30
 * VDDO6  OUT6      155 MHz    LVDS     1.80       16     28
 * VDDO7  OUT7      286 MHz    LVDS     1.80       16     29
 * VDDO8  OUT8      143 MHz    LVDS     1.80       16     28
 * VDDO9  OUT9      226 MHz    LVDS     1.80       32     57
 *        OUT9A     113 MHz    LVDS
 *                                   -------  -------  -----
 *                                      1.80      436    784
 *                                      3.30      121    398
 ...
 * 0x0235[43:0]  MXAXB_NUM                   622770257920       0x09100000000    
 * 0x023B[31:0]  MXAXB_DEN                   2147483648         0x80000000       
 * 0x0247[23:0]  R0A_REG                     5                  0x000005         
 ...
 * 0x030D[43:0]  N1_NUM                      116769423360       0x01B30000000    
 * 0x0313[31:0]  N1_DEN                      3791650816         0xE2000000       
 * 0x0317[0]     N1_UPDATE                   0                  0x0              
 * 0x0318[43:0]  N2_NUM                      58384711680        0x00D98000000    
 * 0x031E[31:0]  N2_DEN                      2399141888         0x8F000000       
 * 0x0322[0]     N2_UPDATE                   0                  0x0              
 * 0x0323[43:0]  N3_NUM                      93415538688        0x015C0000000    
 * 0x0329[31:0]  N3_DEN                      4160749568         0xF8000000       
 * 0x032D[0]     N3_UPDATE                   0                  0x0              
 * 0x032E[43:0]  N4_NUM                      46707769344        0x00AE0000000    
 * 0x0334[31:0]  N4_DEN                      2281701376         0x88000000       
